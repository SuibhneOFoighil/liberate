...
class YTVideoChunk:
  def __init__(self, politican, video_id, transcript, timestamp=0, prev=NULL_ID, next=NULL_ID) -> None:
    self.politican = politican
...
class YTVideo:
  def __init__(self, politican, video_id, transcript, title, creation_date, window=30) -> None:
    self.chunks = []
    self.politican = politican
    self.id = video_id
    self.title = title
